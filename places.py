...
for dir_name in dirs:
    print('<menu id="{menu_id}" label="{dir_name}" execute="{menu_command}"/>'.format(menu_id=dir_name,dir_name=dir_name,menu_command="~/Code/places.py " + os.path.expanduser(os.path.join(dir_path,dir_name))))
